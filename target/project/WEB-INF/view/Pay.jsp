        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2><b> Nạp tiền vào tài khoản </b></h2>
                        </div>
                        <div class="col-sm-6">
                        </div>
                    </div>
            ...
            <div id="editEmployeeModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="AddPay.html" method="get">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="taikhoan" class="form-select" aria-label="Default select example">
                                       <c:forEach items="${list_tk}" var="lsp">
                                            <option value="${lsp.getMaTK()}">${lsp.getMaTK()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" value="Nạp">
                            </div>
                        </form>
                    </div>
                </div>
