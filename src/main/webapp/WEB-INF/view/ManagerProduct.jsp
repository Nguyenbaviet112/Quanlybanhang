                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <form action="SearchSP.html" method="get">
                    ...
                    <tbody>
                        <c:forEach items="${list_sp}" var="sp">
                            <tr>
                                ...
                                <td>${sp.giaSanPham}</td>
                                <td>
                                    <a href="Edit.html?MaSanPham=${sp.getMaSanPham()}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="Delete.html?MaSanPham=${sp.getMaSanPham()}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
